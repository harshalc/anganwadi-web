                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Aganvadi" class="form-label">Aganvadi Kendra<sup class="text-danger">*</sup></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label for="" class="form-label">Pass out Date from Aganwadi</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label for="" class="form-label">Pass out Date Photo</label>
